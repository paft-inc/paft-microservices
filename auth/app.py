...
def registrar():
    ...
    with tracer.start_as_current_span("registrar") as rollspan:
        ...
        rollspan.set_attribute("registrar_usuario", data ['usuario'])
        rollspan.set_attribute("registrar_senha", data ['senha'])
        return retorno
...
def login():
    ...
    with tracer.start_as_current_span("login") as rollspan:
        rollspan.set_attribute("login_usuario", usuario)
        
        rollspan.set_attribute("login_senha", senha)
        return resultado
